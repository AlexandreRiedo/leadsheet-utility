...
- **Five exercises** from jazz pedagogy:
  - *Free Mode*: the chord-scale
  - *Guide Tone*: voice-led 3rd/7th line
  - *Contour*: a lit window drifts across the keyboard
  - *Flow*: projection gates on/off to force phrasing
  - *Start & End Note*: entry and target note per phrase
...
- FluidSynth system library (Windows: `choco install fluidsynth`; Debian/Ubuntu: `apt install libfluidsynth3`)
- A projector as secondary display
