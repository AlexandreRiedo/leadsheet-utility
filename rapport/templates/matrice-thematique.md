# Matrice thématique : entretiens semi-ouverts (Q3), n = 8

> Couche **analyse** des entretiens (cf. `plan-analyse-tests.md` §7.2). On lit **un
> thème en travers des 8 participants** = la « tendance thématique » demandée par Patrick.
...
>   1-2 verbatim. Descriptif, on rapporte ce que les gens disent.
> - **Discussion (triangulation)** = croiser ces thèmes avec les scores RTLX / STAI-6 /
>   auto-efficacité et confronter le pari Q8 au mesuré (cf. `plan-analyse-tests.md` §7.2 pt 4).
>   Réservé à la sous-section Discussion : **ne pas l'écrire dans cette matrice**.

---

## 1. Légende des thèmes (grille a priori, ancrage sur le guide Q3)
...
## 4. Tableau des paris (Q8) : auto-évaluation confrontée au mesuré

> Q8 n'est pas un thème : c'est la **triangulation objectif/subjectif**. Le participant parie
> avoir « mieux joué » AVEC ou SANS ; on confronte ce pari au RTLX / à la perf mesurée.

| Participant | Pari (mieux joué) | Confiance (%) | RTLX plus bas côté | Concordance pari ↔ mesuré |
|---|---|---|---|---|
| P01 | AVEC / SANS / égal | | AVEC / SANS | oui / non / n.d. |
| P02 | | | | |
| P03 | | | | |
| P04 | | | | |
| P05 | | | | |
...
## 5. Synthèse par thème (sortie Résultats §6.3)

> Une ligne par thème lue **en travers des 8**. C'est **ce texte** qui va dans la
> sous-section « Interviews semi-structurées post-expérimentales ». Rester **descriptif** :
> pas de « donc l'artefact réduit la charge » ici (ça, c'est la Discussion).
...
## 6. Rappel : ce qui va où

- **Résultats (§6.3)** : §1 (légende), §3 (matrice remplie en annexe ou support), §5
  (synthèse par thème), §4 (descriptif des paris). Descriptif uniquement.
- **Discussion (triangulation)** : croiser §5 avec les scores (ex. « la charge temporelle
  ne baisse pas AVEC sur les morceaux rapides **et** k/8 disent les lumières trop rapides »),
  confronter la colonne *Concordance* du §4 au RTLX, répondre **QR1 / QR2**. C'est là, pas ici.
