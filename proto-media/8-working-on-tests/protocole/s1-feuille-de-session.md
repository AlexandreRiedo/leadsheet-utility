# Feuille de session (expérimentateur)
...
Consentement signé ☐  Q0 rempli ☐  Familiarisation faite (avec + sans) ☐  Entretien enregistré ☐

## Incidents / écarts au protocole

*(bug, baisse de tempo −10 BPM, reclassement de niveau, interruption, aide donnée, problème de calibration…)*
...
*(regard grille vs touches, arrêts de jeu, moments de blocage, réactions verbales…)*
