...
Semi-structuré. Objectif : savoir **dans quel cadre pédagogique** mettre à disposition le dispositif, d'un POV de pédagogue jazz pro.
...
- **Méthodologie annoncée** : présentation du projet → discussion +/- → discussion pédagogique.
...
- **Analogie disruptive** : comme le métronome, comme l'IA — outils qui changent la façon d'apprendre. Le prof voit-il un parallèle ?
- Le fait de "voir" les notes justes — ça court-circuite l'oreille, ou ça l'aide à se construire ?

---

## 3. Cadre d'utilisation pédagogique (4-5 min) — **cœur de l'interview**

- **Quand l'utiliser dans le parcours d'un élève ?** Débutant en impro / intermédiaire / avancé ? Faut-il "les bases" d'abord (analogie IA) ?
- **Modalité** :
  - Seul ? À deux ? À distance ?
  - En hybride avec le prof, ou en autonomie entre les cours ?
...
- **Type d'activités** que ça débloque : travail des guide tones, des contours mélodiques, du phrasé… Quelles activités existantes ça remplace / complète ?
- **Idées du prof** : voit-il d'autres exercices / jeux qu'on pourrait y mettre ? D'autres usages auxquels je n'aurais pas pensé ?
