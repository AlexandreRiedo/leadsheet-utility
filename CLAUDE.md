...
3. **Solution conceptuelle de l'artefact** — the high-level concept diagram, the automatic-analysis → grid flow, and the role of OMR (mention it here, with the tests demonstrating its value).
